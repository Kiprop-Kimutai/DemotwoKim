...
/*
	...
	cJSON *personaldetails = cJSON_CreateObject();
	cJSON_AddStringToObject(personaldetails,"firstname","apache spark");
	cJSON_AddStringToObject(personaldetails,"lastname","Hewlett packard");
	cJSON_AddStringToObject(personaldetails,"programme","WFP");
	cJSON_AddStringToObject(personaldetails,"age","27");
*/
...
//				Display_Demo();
			...
			case 3:
				...
				//createApplicationAndFileAndWriteData(txToPosted,"testing");
				testnfc();
				break;
			case 4:
				//createApplicationAndFileAndWriteData(txToPosted,"testing");
				...
				break;
			case 5:
				personalizecard("{'firstname':'jonah','lastname':'kimutai','age':'24'}","xxxx");
				//cardlogic();
				break;
			case 6:
				cardoperations(1,"","","","","");
				break;
			case 7:
				cardoperations(2,"","","","mpesa*ben2ben*10","kipkeukipropkimutai");
				break;
			case 8:
				cardoperations(3,"","","","","");
				break;
